...
//		DbunitBaseRepositoryTest.initHibernate("com/mawujun/entityTestService/hibernate.properties");
//		//entityTestService=new  EntityTestRepository();
//		sessionFactory=HibernateUtils.getSessionFactory("com/mawujun/entityTestService/hibernate.cfg.xml","com/mawujun/entityTestService/hibernate.properties");
//		sqlSessionFactory=MybatisUtils.getSessionFactory("com/mawujun/entityTestService/Configuration.xml");
//		//entityTestService.setSessionFactory(sessionFactory);
//		//entityTestService.setSqlSessionFactory(sqlSessionFactory);
//		
...
//		
//		entityTestService= sqlSessionFactory.openSession().getMapper(EquipmentTypeRepository.class);
...
//		PageResult<EntityTest> lists=entityTestService.queryPage(param);
...
//			entityTestService.create(entity1);//这里就报错了
//			//tx.commit();
//		} catch(Exception e){
//			//tx.rollback();
//			throw e;
...
//		entity.setId(1);
//		entity.setVersion(1);
//		entityTestService.update(entity);
//		//tx.commit();
//		
...
//		entity.setId(1);
//		entityTestService.delete(entity);
//		//tx.commit();
//		
...
//		//Transaction tx = sessionFactory.getCurrentSession().beginTransaction(); 
//		entityTestService.deleteById(1);
//		//tx.commit();
//		
//		assertEquals(2,DbunitBaseRepositoryTest.getDbConn().getRowCount(EntityTest_TableName));
//		ITable table =DbunitBaseRepositoryTest.getDbConn().createQueryTable(EntityTest_TableName, "select * from "+EntityTest_TableName+" where id=1");
...
//			entitys[i]=entity;
//		}
//		entityTestService.createBatch(entitys);
//		//tx.commit();
...
//		
//		entityTestService.deleteBatch(entity1,entity2);
//		//tx.commit();
...
//	}
	...
	public void testBatchDeleteCollectionOfT() throws DataSetException, SQLException {
		...
		entityTestService.deleteBatch(entitys);
		
		assertNull(entityTestService.get(1));
...
//		//Transaction tx = sessionFactory.getCurrentSession().beginTransaction(); 
//		
//		entityTestService.deleteBatch(1,2);
//		//tx.commit();
//		assertEquals(1,DbunitBaseRepositoryTest.getDbConn().getRowCount(EntityTest_TableName));
//		
//		ITable table =DbunitBaseRepositoryTest.getDbConn().createQueryTable(EntityTest_TableName, "select * from "+EntityTest_TableName+" where id=1 or id=2");
...
//		//Transaction tx = sessionFactory.getCurrentSession().beginTransaction(); 
//		entityTestService.deleteAll();//.deleteAllBatch();
//		//tx.commit();
//		
...
//		
//		//Transaction tx = sessionFactory.getCurrentSession().beginTransaction();
//		entityTestService.deleteBatch(Cnd.select().andIn("age", 20,30));
//		//tx.commit();
//		
//		ITable table =DbunitBaseRepositoryTest.getDbConn().createTable(EntityTest_TableName);
//		assertEquals(1,table.getRowCount());
...
//		entityTestService.updateIgnoreNull(entity);
//		//tx.commit();
//		
//		
...
//		entityTestService.updateIgnoreNull(entity);
//		
//		EntityTest entity1=entityTestService.get(1);
...
//		entity2.setVersion(1);
//		entityTestService.updateBatch(entity1, entity2);
//		//tx.commit();
//		
//		ITable table =DbunitBaseRepositoryTest.getDbConn().createTable(EntityTest_TableName);
//		assertEquals(3,table.getRowCount());
...
//		entitys.add(entity1);
//		entitys.add(entity2);
//		entityTestService.updateBatch(entitys);
//		//tx.commit();
//		
//		ITable table =DbunitBaseRepositoryTest.getDbConn().createTable(EntityTest_TableName);
//		assertEquals(3,table.getRowCount());
...
//		//Transaction tx = sessionFactory.getCurrentSession().beginTransaction(); 
//		List<EntityTest> entitys=entityTestService.queryAll();
//		//tx.commit();
//		
...
//		
//		List<EntityTest> entitys=entityTestService.query(cnd);
//		//tx.commit();
//		assertEquals(2,entitys.size());
//		//assertEquals(1,entitys.getTotalPages());
//	}
...
//		
//		int counts=entityTestService.queryCount(cnd);
//		//tx.commit();
...
//		
//		EntityTest entitys=entityTestService.queryUnique(cnd);
//		//tx.commit();
...
//		Cnd cnd=Cnd.where().and("id","=", 1);//.andLike("firstName", "admin").andIn("lastName", "123","1234");
//		
//		EntityTest entitys=entityTestService.queryUnique(cnd,EntityTest.class);
//		//tx.commit();
//		assertEquals((Integer)1,entitys.getId());
//		//assertEquals(1,entitys.getTotalPages());
//	}
...
//		
//		Integer entitys=entityTestService.queryUnique(cnd,Integer.class);
//		//tx.commit();
...
//		
//		Map entitys=entityTestService.queryUnique(cnd,Map.class);
//		//tx.commit();
...
//		
//		Object entitys=entityTestService.queryMax("id",cnd);
//		//tx.commit();
